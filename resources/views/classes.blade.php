    ...
    <body class="  bg-slate-200 ">
        <div class="  container mx-auto mt-20  " >
          ...
          <form action="{{ route('logout') }}" method="POST">
            ...
            <p class="text-2xl  font-bold text-gray-400"> Table Classe</p>
            <div class="flex   justify-end ">
            <a  href="{{ url('classes/create')}}" class="bg-sky-500  text-center  w-1/6 h-12 hover:bg-sky-900 text-white font-bold py-2 px-4 border border-sky-500 rounded">
                Ajouter Classe
              </a>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b">
                            ...
                            <td class="text-sm font-light px-6 py-4 flex whitespace-nowrap ">
                              <a href="/formations/classe/etudiants/{{ $classe->idc  }}" class="bg-green-500 mx-5 hover:bg-green-900 text-white font-bold py-2 px-4 border border-green-500 rounded">
                                Afficher Les Etudiants
                              </a>
                                <a href="/classes/{{ $classe->idc  }}/edit" class="bg-green-500 mx-5 hover:bg-green-900 text-white font-bold py-2 px-4 border border-green-500 rounded">
                                    UPDATE
                                </a>
