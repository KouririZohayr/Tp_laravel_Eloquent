<html>
  ...
  <body class="min-h-screen bg-gray-200 text-gray-900 flex justify-center">
    <div
    ...
    >
      <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        <div>
          <img
            src="https://envision.com.np/wp-content/uploads/2018/01/laravel-logo.png"
            class="w-32 mx-auto"
          />
        </div>
        ...
        <form action="{{ route('login') }}" method="POST">
            ...
            <h1 class=" text-xl mt-2 text-gray-600 text-center"><a href="/register">Create account ? </a> </h1>
    ...
    <div class="REMOVE-THIS-ELEMENT-IF-YOU-ARE-USING-THIS-PAGE hidden treact-popup fixed inset-0  items-center justify-center" style="background-color: rgba(0,0,0,0.3);">
